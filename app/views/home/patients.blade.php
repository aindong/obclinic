                            ...
                            <div class="list-results">
                                <div class="col-xs-12 col-lg-6 hbox-xs">
                                    <div class="hbox-column width-2">
                                        <img class="img-circle img-responsive pull-left" src="../../../assets/img/modules/materialadmin/avatar9463a.jpg?1422538626" alt="" />
                                    </div><!--end .hbox-column -->
                                    <div class="hbox-column v-top">
                                        <div class="clearfix">
                                            <div class="col-lg-12 margin-bottom-lg">
                                                <a class="text-lg text-medium" href="details.html">Ann Laurens</a>
                                            </div>
                                        </div>
